...
from multi_class_prompt import PROMPT_MULTI, PROMPT_SIMPLIFIED
...
class MFCFineTuner:
    ...
    def evaluate(self, eval_set):
        ...
        for sample in tqdm(eval_set):
            ...
            sample_label = sample_label.strip('<|endoftext|>')
            ...
            prediction = prediction.strip('<|endoftext|>')
        ...
        #   prediction_label = prediction
            ...
            to_write.append({"label": true_label, "prediction": prediction})
    ...
    def main(self):
        ...
        num_evals_per_save = 4  
        save_steps = eval_steps * num_evals_per_save
